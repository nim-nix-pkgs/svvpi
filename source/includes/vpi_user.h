...
#define vpiConstantSelect        53  /* (boolean) bit-select or part-select indices are constant expressions */
...
#define vpiResolvedNetType       61  /* net subtype after resolution, returns same subtypes as vpiNetType */
...
/* vpiValid,vpiValidTrue,vpiValidFalse is deprecated in 1800-2009 */
#define vpiValidFalse              0
#define vpiValidTrue               1
#define vpiSigned                65  /* TRUE for vpiIODecl and any object in the expression class if the object has the signed attribute */
